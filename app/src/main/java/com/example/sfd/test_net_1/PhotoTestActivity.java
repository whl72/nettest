...
public class PhotoTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button takepohoBT = (Button) findViewById(R.id.button_takephoto);
//        Button choosePhoto = (Button) findViewById(R.id.button_choose_photo);
        picture = (ImageView) findViewById(R.id.user_phototest);
        takepohoBT.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if(Build.VERSION.SDK_INT >= 24){
                    imageUri = FileProvider.getUriForFile(PhotoTestActivity.this,
                            "com.example.sfd.test_net_1.fileprovider", outputImage);
                }else {
...
//            @Override
//            public void onClick(View view) {
//                if(ContextCompat.checkSelfPermission(PhotoTestActivity.this,
//                        Manifest.permission.WRITE_EXTERNAL_STORAGE) !=
//                        PackageManager.PERMISSION_GRANTED){
//                    ActivityCompat.requestPermissions(PhotoTestActivity.this,
